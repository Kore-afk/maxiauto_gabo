  ...
  return (
    <nav className="flex flex-col relative h-screen max-w-sm w-full">
      <div className="flex justify-center m-5">
        <div className="text-white text-lg">MaxiAuto</div>
      </div>
      {navItems.map((item) => (
        <div
          className={cn(
            ...
            pathname === item.link
              ...
              : "hover:bg-red-700 hover:text-white bg-transparent rounded-none",
            "justify-start"
          )}
          key={item.name}
        >
      ...
      <div
        className={cn(
          ...
          pathname === "/login"
            ? "bg-white text-white-800 hover:bg-white rounded-none"
            : "hover:bg-red-800 hover:text-white bg-transparent rounded-none",
          "justify-start"
        )}
      >
